...
phases = {
    "Phase 1: Python Master": range(1, 31),
    "Phase 2: Data Analytics (Pandas/NumPy)": range(31, 61),
...
for phase_name, days in phases.items():
    ...
    if "Python" in phase_name:
        print("   Goal: Master OOP and Data Structures.")
    elif "Analytics" in phase_name:
        print("   Goal: Clean messy data and build charts.")
